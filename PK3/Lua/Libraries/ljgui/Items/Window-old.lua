...
-- 	local children, layout, autoSize
-- 	if props then
-- 		children, props.children = $2, {}
-- 		layout, props.layout = $2, nil
-- 		autoSize, props.autoSize = $2, nil
-- 	end
...
-- 	local mainArea = self.mainArea

-- 	self:setLayout({ strategy = Window.layoutStrategy })

-- 	if mainArea.autoAttributes.width
-- 	and gui.autoAttributeStrategies["width"][mainArea.autoAttributes.width.strategy].dependencyType == "children" then
...
-- 	if mainArea.autoAttributes.width
-- 	and mainArea.autoAttributes.height and gui.autoAttributeStrategies["height"][mainArea.autoAttributes.height.strategy].dependencyType == "children" then
